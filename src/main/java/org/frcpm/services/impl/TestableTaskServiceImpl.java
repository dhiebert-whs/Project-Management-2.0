// src/main/java/org/frcpm/services/impl/TestableTaskServiceImpl.java
...
/**
 * A testable implementation of TaskService that accepts injected repositories
 ...
 */
public class TestableTaskServiceImpl implements TaskService {
    
    private static final Logger LOGGER = Logger.getLogger(TestableTaskServiceImpl.class.getName());
     ...
     */
    public TestableTaskServiceImpl() {
        this(
