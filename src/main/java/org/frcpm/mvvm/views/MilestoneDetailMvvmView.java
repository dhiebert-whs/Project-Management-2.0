// src/main/java/org/frcpm/mvvm/views/MilestoneDetailMvvmView.java
...
/**
 * View for the milestone detail using MVVMFx.
 */
public class MilestoneDetailMvvmView implements FxmlView<MilestoneDetailMvvmViewModel>, Initializable {
    
    private static final Logger LOGGER = Logger.getLogger(MilestoneDetailMvvmView.class.getName());
    ...
    public void initialize(URL location, ResourceBundle resources) {
        LOGGER.info("Initializing MilestoneDetailMvvmView");
    ...
    private void setupBindings() {
        ...
        if (nameTextField == null || datePicker == null || descriptionTextArea == null || 
            projectLabel == null || saveButton == null || cancelButton == null) {
    ...
    /**
     * Initializes the view with a new milestone.
     * 
     * @param project the project for the milestone
     */
    public void initNewMilestone(org.frcpm.models.Project project) {
        try {
    ...
    /**
     * Initializes the view with an existing milestone.
     * 
     ...
     */
    public MilestoneDetailMvvmViewModel getViewModel() {
        return viewModel;
    }
}