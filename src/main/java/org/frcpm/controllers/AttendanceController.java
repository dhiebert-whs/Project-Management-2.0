...
public class AttendanceController {
    ...
    private void initialize() {
        ...
        presentColumn.setCellValueFactory(cellData -> 
            new javafx.beans.property.SimpleBooleanProperty(cellData.getValue().isPresent()));
        ...
        arrivalColumn.setCellValueFactory(cellData -> 
            new javafx.beans.property.SimpleObjectProperty<>(cellData.getValue().getArrivalTime()));
        
        departureColumn.setCellValueFactory(cellData -> 
            new javafx.beans.property.SimpleObjectProperty<>(cellData.getValue().getDepartureTime()));
        
        // Format time cells
        DateTimeFormatter timeFormatter = DateTimeFormatter.ofPattern("HH:mm");
        
        Callback<TableColumn<TeamMemberAttendanceRecord, LocalTime>, TableCell<TeamMemberAttendanceRecord, LocalTime>> 
            timeCellFactory = column -> new TableCell<TeamMemberAttendanceRecord, LocalTime>() {
                @Override
