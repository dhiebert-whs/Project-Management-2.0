// src/test/java/org/frcpm/repositories/test/InMemoryTaskRepository.java
...
/**
 * In-memory implementation of TaskRepository for integration testing.
 */
    ...
    public List<Task> findByProject(Project project) {
        ...
        return tasks.values().stream()
                .filter(task -> task.getProject() != null && 
                       Objects.equals(task.getProject().getId(), project.getId()))
    ...
    public List<Task> findBySubsystem(Subsystem subsystem) {
        ...
        return tasks.values().stream()
                .filter(task -> task.getSubsystem() != null && 
                       Objects.equals(task.getSubsystem().getId(), subsystem.getId()))
                .collect(Collectors.toList());
    }
