...
public class TeamViewModelTest {
    ...
    @Test
    public void testEditAndCreateCommands() {
        // Test edit member command
        assertFalse(viewModel.getEditMemberCommand().canExecute());
        viewModel.setSelectedMember(testMember);
        assertTrue(viewModel.getEditMemberCommand().canExecute());

        // Test edit subteam command
        assertFalse(viewModel.getEditSubteamCommand().canExecute());
        viewModel.setSelectedSubteam(testSubteam);
        assertTrue(viewModel.getEditSubteamCommand().canExecute());

        // Test create new member command
        viewModel.getCreateNewMemberCommand().execute();
        assertTrue(viewModel.isNewMember());

        // Test create new subteam command
        viewModel.getCreateNewSubteamCommand().execute();
        assertTrue(viewModel.isNewSubteam());
    }
