...
public class ProjectControllerTest {
    ...
    public void setUp() {
        ...
        when(mockViewModel.projectNameProperty()).thenReturn(new javafx.beans.property.SimpleStringProperty(testProject.getName()));
        when(mockViewModel.projectDescriptionProperty()).thenReturn(new javafx.beans.property.SimpleStringProperty(testProject.getDescription()));
        when(mockViewModel.startDateProperty()).thenReturn(new javafx.beans.property.SimpleObjectProperty<>(testProject.getStartDate()));
        when(mockViewModel.goalEndDateProperty()).thenReturn(new javafx.beans.property.SimpleObjectProperty<>(testProject.getGoalEndDate()));
        when(mockViewModel.hardDeadlineProperty()).thenReturn(new javafx.beans.property.SimpleObjectProperty<>(testProject.getHardDeadline()));
        when(mockViewModel.completionPercentageProperty()).thenReturn(new javafx.beans.property.SimpleDoubleProperty(50.0));
    ...
    public void testSetProject() {
        ...
        verify(controller).testLoadProjectData();
    }
    ...
    public void testHandleMilestoneCommands() throws Exception {
        ...
        java.lang.reflect.Field addMilestoneCommandField = ProjectController.class.getDeclaredField("addMilestoneCommand");
    ...
    public void testHandleMeetingCommands() throws Exception {
        ...
        java.lang.reflect.Field scheduleMeetingCommandField = ProjectController.class.getDeclaredField("scheduleMeetingCommand");
