...
/**
 * Tests for the MilestoneController class focusing on ViewModel interactions without JavaFX dependencies.
 */
...
public class MilestoneControllerTest {
    ...
    @BeforeEach
    public void setUp() {
        // Create a real controller - we'll only test its ViewModel interactions
